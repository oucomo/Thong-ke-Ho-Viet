...
library(writexl)
write_xlsx(data_ho_top10000, "Top 10000 ho.xlsx")
...
library(writexl)
write_xlsx(data_ho_top3000, "Top 3000 ho.xlsx")
...
ggsave(filename = file.path("Ho Nguyen-PerPop.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("Ho Mai-PerPop.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("Ho Quach-PerPop.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("Ho Mai-PerArea.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("Ho Quach-PerArea.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("figures", "Mai-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("figures", "Quach-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("figures", "Mai-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggsave(filename = file.path("figures", "Quach-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Bui-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Nguyen-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Trieu-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Dinh-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Ly-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Le-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Tran-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Du-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Ngo-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Doan-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Trinh-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Duong-Contour-River.jpeg"), width = 49, height = 33)
```
## Họ Hồ
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Ho-Contour-River.jpeg"), width = 49, height = 33)
```
## Họ Hoàng
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Hoang-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Huynh-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Phan-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Pham-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Vu-Contour-River.jpeg"), width = 49, height = 33)
```
...
vo_f <- sf::st_transform(vu_f, 2154)
vo_plot <- vo_sf %>% select(pro.pop, prop.vo, geometry) %>% st_as_sf(crs = 4326)
# Convert to Spatial class
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Vo-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Phung-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Do-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Khuc-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Mac-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Mai-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Ton-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=pot, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Truong-Contour-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=potf, aes(fill=min), lwd=0) +
  ...
  coord_sf(crs = 4326)
ggsave(filename = file.path("figures", "Bui-Contour-River-Area.jpeg"), width = 49, height = 33)
```
...
#   coord_sf(crs = 4326)
# #ggsave(filename = file.path("figures", "Hoang-PerArea-River.png"), width = 49, height = 33)
# ggsave(filename = file.path("figures", "Bui-Contour-River-Area(2).jpeg"), width = 49, height = 33)
```
...
khuc_tinh = merge(khuc_tinh, data_tinh, by="MATINH") %>%
  arrange(desc(pro.pop))
write_xlsx(khuc_tinh, "Khuc_tinh.xlsx")
```
...
du_tinh = merge(du_tinh, data_tinh, by="MATINH") %>%
  arrange(desc(pro.pop))
write_xlsx(du_tinh, "Du_tinh.xlsx")
```

```{r}
#save(dat_f, dat_sf, dat_sff, data_ho, data_ho_overall, data_ho_tinh, data_ho_xa, data_huyen, data_pop, data_tinh, data_xa, river3, file = "hoviet.RData")
```

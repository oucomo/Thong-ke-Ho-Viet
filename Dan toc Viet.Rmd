...
ggplot() + geom_sf() + geom_sf(data=vietic_plotf, aes(fill=songuoi), lwd=0) +
  ...
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(vietic_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=taikadai_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(taikadai_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ Tày - Thái (Tai–Kadai)")
ggsave(filename = file.path("figures", "Dan toc", "1-2-Tai–Kadai.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=kra_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(kra_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ Kadai (Kra)")
ggsave(filename = file.path("figures", "Dan toc", "1-3-Kra.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=austroasiatic_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(austroasiatic_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ Môn – Khmer (Nam Á) (Austroasiatic non-Vietic)")
ggsave(filename = file.path("figures", "Dan toc", "1-4-Austroasiatic.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=hmongmien_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(hmongmien_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ H'Mông - Dao (Hmong–Mien)")
ggsave(filename = file.path("figures", "Dan toc", "1-5-Hmong–Mien.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=malayopolynesia_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(malayopolynesia_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ Nam Đảo (Malayo-Polynesia)")
ggsave(filename = file.path("figures", "Dan toc", "1-6-Malayo-Polynesia.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=austro_malay_plotf, aes(fill=prop), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste("Tỉ lệ chung", as.numeric(austro_malay_plotf$prop.chung[1]), "lần", sep = " ")) +
...
ggplot() + geom_sf() + geom_sf(data=sinitic_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(sinitic_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Ngữ hệ Hán (Sinitic)")
ggsave(filename = file.path("figures", "Dan toc", "1-7-Sinitic.png"), width = 16, height = 25)
```
...
ggplot() + geom_sf() + geom_sf(data=tibetburma_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(tibetburma_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=kinh_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(kinh_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Kinh Việt")
ggsave(filename = file.path("figures", "Dan toc", "1-1-Kinh.png"), width = 16, height = 25)
```
...
chut_sff <- merge(dat_sff, chut_tong %>% select(chut, tong, NAME_1), by=c("NAME_1"))
...
ggplot() + geom_sf() + geom_sf(data=chut_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(chut_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
muong_sff <- merge(dat_sff, muong_tong %>% select(muong, tong, NAME_1), by=c("NAME_1"))
...
ggplot() + geom_sf() + geom_sf(data=muong_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(muong_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
tho_sff <- merge(dat_sff, tho_tong %>% select(tho, tong, NAME_1), by=c("NAME_1"))
...
ggplot() + geom_sf() + geom_sf(data=tho_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(tho_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=boy_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(boy_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=giay_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(giay_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=lao_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(lao_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=lu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(lu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=nung_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(nung_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Nùng")
...
ggplot() + geom_sf() + geom_sf(data=sanchay_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(sanchay_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=tay_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(tay_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Tày Thổ")
...
ggplot() + geom_sf() + geom_sf(data=thai_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(thai_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=colao_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(colao_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=lachi_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(lachi_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=laha_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(laha_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=pupeo_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(pupeo_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=bana_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(bana_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=brau_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(brau_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Brâu Brao")
...
ggplot() + geom_sf() + geom_sf(data=bru_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(bru_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=choro_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(choro_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=co_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(co_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=coho_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(coho_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Cơ Ho (Koho)")
...
ggplot() + geom_sf() + geom_sf(data=cotu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(cotu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=gietrieng_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(gietrieng_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=hre_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(hre_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=khang_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(khang_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=khmer_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(khmer_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Khmer (Khmer)")
...
ggplot() + geom_sf() + geom_sf(data=khomu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(khomu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=ma_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(ma_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Mạ")
...
ggplot() + geom_sf() + geom_sf(data=mang_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(mang_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=mnong_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(mnong_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=odu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(odu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=romam_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(romam_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Rơ Măm")
...
ggplot() + geom_sf() + geom_sf(data=taoi_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(taoi_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=xinhmun_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(xinhmun_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=xodang_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(xodang_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=xtieng_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(xtieng_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=dao_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(dao_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=hmong_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(hmong_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=pathen_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(pathen_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=cham_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(cham_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=churu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(churu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=ede_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(ede_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=giarai_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(giarai_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=raglai_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(raglai_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=hoa_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(hoa_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=ngai_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(ngai_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=sandiu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(sandiu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=cong_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(cong_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("Cống (Phunoi)")
...
ggplot() + geom_sf() + geom_sf(data=hanhi_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(hanhi_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=lahu_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(lahu_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
  ggtitle("La Hủ (Lahu)")
...
ggplot() + geom_sf() + geom_sf(data=lolo_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(lolo_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=phula_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(phula_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +
...
ggplot() + geom_sf() + geom_sf(data=sila_plotf, aes(fill=songuoi), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(as.numeric(sila_plotf$tong), "người", sep = " ")) +
  scale_fill_viridis("Số người", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 30)) +

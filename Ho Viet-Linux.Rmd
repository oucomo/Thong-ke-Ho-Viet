...
#render_depth(focallength=100,focus=0.72)
rglwidget()
render_movie("figures/3D2/mai(2).mp4",frames = 720, fps=30,zoom=0.6,fov = 30)

plot_gg(gg_mai, multicore = TRUE, width = 10 ,height=15, fov = 70)
#render_depth(focallength=100,focus=0.72)
...
for(i in 1:2) {
 ...
 render_snapshot(paste0("figures/3D2/frame", i, ".png"))}
  # Close the window when you're done
rgl::rgl.close()
rglwidget()

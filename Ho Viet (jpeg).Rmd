...
jpeg(filename = "Ho Nguyen-PerPop.jpg", width = 12000, height = 18000)
ggplot() + geom_sf() + geom_sf(data=nguyen_plot, aes(fill=pro.pop), lwd=0) +
  annotate(geom="text", x=108, y=23, color="red", size=90, label= paste(round(nguyen_plot$prop.nguyen[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Tỉ lệ (%) trên dân số địa phương", direction = -1, option = "viridis") +
  theme(text = element_text(size=240), axis.text.x = element_text(size=180), axis.text.y = element_text(size=180), legend.text=element_text(size=180), legend.key.size = unit(15, "cm")) +
  ggtitle("Họ Nguyễn")
dev.off()
```
...
jpeg(filename = "Ho Tran-PerPop.jpg", width = 15000, height = 20000)
ggplot() + geom_sf() + geom_sf(data=tran_plot, aes(fill=pro.pop, lwd=0)) +
  annotate(geom="text", x=108, y=23, color="red", size=90, label= paste(round(tran_plot$prop.tran[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Tỉ lệ (%) trên dân số địa phương", direction = -1, option = "viridis") +
  theme(text = element_text(size=240), axis.text.x = element_text(size=180), axis.text.y = element_text(size=180), legend.text=element_text(size=180), legend.key.size = unit(15, "cm")) +
  ggtitle("Họ Trần")
dev.off()
...
ggplot() + geom_sf() + geom_sf(data=du_plot, aes(fill=pro.pop)) +
...
#colnames(doan_plot) <- c("Tỉ lệ % họ trên tổng dân số", "geometry")
ggplot() + geom_sf(data=ngo_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=trieu_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=mac_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=phung_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=khuc_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=pham_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=ho_plot, aes(fill=pro.pop)) +
...
ggplot() + geom_sf() + geom_sf(data=ton_plot, aes(fill=pro.pop)) +

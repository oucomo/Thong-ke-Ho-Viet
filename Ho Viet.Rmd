...
data_ho$Ho <- ifelse((data_ho$Ho == "Am" | data_ho$Ho == "AM" | data_ho$Ho == "am'" | data_ho$Ho == "An" | data_ho$Ho == "AN" | data_ho$Ho == "an"), "An", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Au|au|AU|Áu|ÁU|Âu|ÂU|âu|Ău|Ấu|ấu|Ấu|Ẩu|Ậu") == TRUE, "Âu", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Bạc" | data_ho$Ho == "Bạc" | data_ho$Ho == "bạc" | data_ho$Ho == "bạc" | data_ho$Ho == "BẠC" | data_ho$Ho == "Bặc"), "Bạc", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Bạcb|Băch|Bạch|bạch|BẠCH|Bạch|BẠCH|bạch|Bặch|Bachh|Bachj") == TRUE, "Bạch", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Ban" | data_ho$Ho == "BAN" | data_ho$Ho == "ban'" | data_ho$Ho == "Bán" | data_ho$Ho == "bán" | data_ho$Ho == "Bàn" | data_ho$Ho == "BÀN" | data_ho$Ho == "Bàn" | data_ho$Ho == "bàn" | data_ho$Ho == "bàn" | data_ho$Ho == "Bann" | data_ho$Ho == "Bànthi"), "Bàn", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Bành|bành|BÀNH|Bành|BÀNH|Bảnh|Bạnh") == TRUE, "Bành", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Be|Bé|BÉ|bé|Bé|Bè|Bê|BÊ|Bế|BẾ|Bế|bế|Bề|Bễ|Bẻ|Bể") == TRUE, "Bế", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Biẹn|Biện|BIỆN|biện|Biện|BiỆN|biện|Bịên|Biệng") == TRUE, "Biện", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "bui|Buì|Bui|bùi|Bùi|Bùi|BÙI|BUI|Búi|bùi|Bùi|BùI|BÙi|BÙI|Bùo|Bùu|Bủi|Bừi|Bụi|buí|Buí|buì|BUÌ|Buĩ|búi|Búi|BÚI|Bùi|Bùí|Bùì|Būi|Bũi|BŨI|bũi|bủi|BỦI|Bủi|bụi|BỤI|Bụi|Bul|Bùl|bùo|Bùo|Buof|Buoi|buoi|Buôi|Buồi|Buồi|BUỒI|Buổi|bùu|Buùi|BUÙI|buùi|Buuif|Buỳ|Bùy|Bỳ") == TRUE, "Bùi", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "cao|Cao|CAO|CAo") == TRUE, "Cao", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Cà" | data_ho$Ho == "cà" | data_ho$Ho == "CÀ'" | data_ho$Ho == "cà" | data_ho$Ho == "Cà" | data_ho$Ho == "Că"), "Cà", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Cầm|cầm|CẦM|Cầm|cầm|Cắm|Cằm|Cằm") == TRUE, "Cầm", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Cấn|CẤN|Cấn|cấn|Cần|CẦN|Cần|cần") == TRUE, "Cấn", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Châo|Chảo|Chảo|CHẢO|chảo|CHảO|chảo|CHẢO") == TRUE, "Chảo", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Chau|châu|Châu|CHÂU|chau|CHAU|chAu|Cháu|Cháu|cháu|cháu|CHÁU|Châu|ChÂu|Chău|Chấu|CHẤU|Chấu|chấu|Chầu|Chảu|Chẩu|Chẩu|chẩu|CHẨU|Chậu|Chậu") == TRUE, "Châu", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Chê|CHÊ|chê|Chế|CHẾ|chế|Chế|CHẾ|chế|Chề|chề|CHỀ|Chề|Chể") == TRUE, "Chế", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "chu|Chu|CHU|Chu|CHu|Chú|chú|Chù") == TRUE, "Chu", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đàm|Đàm|ĐÀM|Đàm|Đàm|đàm|Dam|DAM|dam|Dám|Dàm|dàm|Đam|đam|ĐAM|Đám|Đám|Đàm|ĐÀM|Ðàm|Đam") == TRUE, "Đàm", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Đăng|đặng|Đặng|Đặng|ĐẶNG|dặng|Dặng|Đặnh|đặng|ĐặNg|ĐẶNG|Đạng|Đậng|Đặng|Ðặng|Đặnh|Đănhj|Đaặng|Đaặng|Đăặng|ĐĂẶNG|đăặng|Đăbg|Đặbg|Đăbgj|Đaengj|Đặg|Đăgj|Đămg|đămg|Đặmg|Đămgj|Đawng|Đawngi|Đawngj") == TRUE, "Đặng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "danh|Danh|DANH|Damh|damh") == TRUE, "Danh", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "đào" | data_ho$Ho == "Đào" | data_ho$Ho == "Đào" | data_ho$Ho == "ĐÀO" | data_ho$Ho == "Dào" | data_ho$Ho == "Đaò" | data_ho$Ho == "đào" | data_ho$Ho =="ĐàO" | data_ho$Ho == "ĐÀo" | data_ho$Ho == "ĐÀO" | data_ho$Ho == "Đoà" | data_ho$Ho == "Đòa"| data_ho$Ho=="Đaào"| data_ho$Ho=="Đaò"| data_ho$Ho=="đaò"| data_ho$Ho=="ĐAÒ"| data_ho$Ho=="Đào" | data_ho$Ho=="Đàơ" | data_ho$Ho=="Đâo" | data_ho$Ho=="Đâò" | data_ho$Ho=="Dđào" | data_ho$Ho=="DĐÀO" | data_ho$Ho=="DĐÀO"| data_ho$Ho=="DĐào"), "Đào", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đinh|Đinh|ĐINH|Đimh|Din|Đin|Đing|dinh|Dinh|DINH|ĐInh|Đjnh|Đlnh|Đihh|Diinh|Điinh|ĐIINH|Dimh|đimh|ĐIMH|ĐING|đing|Dlnh|đlnh") == TRUE, "Đinh", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đỗ|Đỗ|Đỗ|ĐỖ|Đổ|ĐỖ|Dỗ|đổ|Đổ|ĐỔ|ĐỔ|Đõ|ĐÕ|Đỡ|Dõ|dỗ|DỖ|Dỗ|Dỏ|Dổ|DỔ|dổ|Dỡ|đö|Đō|đõ|Đõ|Đő|Đỗ|đỗ|Đoo|Đoõ|Đoỗ|đoỗ|ĐoỖ|ĐOỖ|Đoỗ|Đoổ|Đôỗ|Đôỗ|Đoox|Đôx|Đôz") == TRUE, "Đỗ", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "đoàn" | data_ho$Ho ==  "Đoàn" | data_ho$Ho == "Đoàn" | data_ho$Ho == "ĐOÀN" | data_ho$Ho == "đoàn" | data_ho$Ho == "ĐoàN" | data_ho$Ho == "ĐOàn" | data_ho$Ho == "ĐOÀN" | data_ho$Ho == "đòan" | data_ho$Ho == "Đòan" | data_ho$Ho == "Đòan" | data_ho$Ho == "ĐÒAN" | data_ho$Ho == "Ðoàn" | data_ho$Ho == "Dđoàn" | data_ho$Ho == "DĐOÀN"| data_ho$Ho == "DĐOÀN"| data_ho$Ho == "dđoàn" |data_ho$Ho == "DĐoàn" |data_ho$Ho == "Đđoàn" |data_ho$Ho == "Đoaàn" |data_ho$Ho == "Đoafn" |data_ho$Ho == "Đoàm" |data_ho$Ho == "đoàm" |data_ho$Ho == "Doàn" |data_ho$Ho == "DOÀN" |data_ho$Ho == "doàn" |data_ho$Ho == "Doàn" |data_ho$Ho == "Dòan" |data_ho$Ho == "Đoàn" |data_ho$Ho == "Đòan" |data_ho$Ho == "Đôàn" |data_ho$Ho == "Ðoàn" |data_ho$Ho == "Đoanf" |data_ho$Ho == "Đôanf" |data_ho$Ho == "Doàng" |data_ho$Ho == "Đoàng" |data_ho$Ho == "đoàng" |data_ho$Ho == "ĐOÀNG" |data_ho$Ho == "Đoàng" |data_ho$Ho == "Đoành" |data_ho$Ho == "Đoànminh" |data_ho$Ho == "Đoànn" |data_ho$Ho == "ĐoànThanh" |data_ho$Ho == "Doanthi" |data_ho$Ho == "ĐoànThi" |data_ho$Ho == "Đoànthi" |data_ho$Ho == "Đoànthij" |data_ho$Ho == "Đooàn" |data_ho$Ho == "Đooàn"), "Đoàn", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Doăn|Doãn|DOÃN|doãn|Doãn|DOÃN|Doẵn|Doản|doản|Doản|Doạn|Doạn|Dõan|DÕAN|Đoãn|ĐOÃN|đoãn|Đoằn") == TRUE, "Doãn", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Đâụ|đâụ|Đâụ|Đạu|Đạu|Đậu|đậu|Đậu|ĐẬU|ĐẬU|đậu|ĐậU|Đặu|Ðậu|Đâuh|Đâuk") == TRUE, "Đậu", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Dới|Đói|Đối|Đối|đối|Đơi|Đơí|Đới|Đới|ĐỚI|đới|ĐỚI|Đời|Đời") == TRUE, "Đới", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Dồng|dồng|Đòng|ĐÒNG|Đồng|ĐỒNG|đồng|Đồng|đồng|ĐỒNG|ĐỒng|Ðồng|Ðồng|Đôngg|Đonh|Đônh|Đồnh|Đônhf|Doòng|Dòong|Đoồng|đoồng|Đôồng") == TRUE, "Đồng", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "dư" | data_ho$Ho == "Dư" | data_ho$Ho == "DƯ" | data_ho$Ho == "Dứ" | data_ho$Ho == "Dừ" | data_ho$Ho == "Dữ" | data_ho$Ho == "Dử" | data_ho$Ho == "Dự" | data_ho$Ho == "dự" | data_ho$Ho == "DỰ" | data_ho$Ho == "Dự" | data_ho$Ho == "Đư" | data_ho$Ho == "Đữ" | data_ho$Ho == "Duso" | data_ho$Ho == "Dưu" | data_ho$Ho == "dưu"), "Dư", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Duong" | data_ho$Ho == "dương" | data_ho$Ho == "Dương" | data_ho$Ho == "DƯƠNG" | data_ho$Ho == "Dươ" | data_ho$Ho == "Dươg" | data_ho$Ho == "Dươg" | data_ho$Ho == "Dươmg" | data_ho$Ho == "Dươn" | data_ho$Ho == "Duỏng" | data_ho$Ho == "Duơng" | data_ho$Ho == "Dươngthanh" | data_ho$Ho == "Dươnh" | data_ho$Ho == "Dươnng" | data_ho$Ho == "ddương" | data_ho$Ho == "Diwowng" | data_ho$Ho == "DJƠNGOH" | data_ho$Ho == "Dueowng" | data_ho$Ho == "Duing" | data_ho$Ho == "Dưing" | data_ho$Ho == "Duiwng" | data_ho$Ho == "Dươbg" | data_ho$Ho == "Duoeng" | data_ho$Ho == "Dưoeng" | data_ho$Ho == "duog" | data_ho$Ho == "Duog" | data_ho$Ho == "DƯƠG" | data_ho$Ho == "Dườg" | data_ho$Ho == "Duomg" | data_ho$Ho == "dươmg" | data_ho$Ho == "DƯƠMG" | data_ho$Ho == "Duon" | data_ho$Ho == "DUÔN" | data_ho$Ho == "DƯƠN" | data_ho$Ho == "DUƠNG" | data_ho$Ho == "duơng" | data_ho$Ho == "Düöng" | data_ho$Ho == "Důöng" | data_ho$Ho == "DŮÖNG" | data_ho$Ho == "Důõng" | data_ho$Ho == "Důőng" | data_ho$Ho == "Dủỏng" | data_ho$Ho == "Dưong" | data_ho$Ho == "DƯONG" | data_ho$Ho == "Dưông" | data_ho$Ho == "dưông" | data_ho$Ho == "Dương" | data_ho$Ho == "Dươngg" | data_ho$Ho == "Duongi" | data_ho$Ho == "Dươngminh" | data_ho$Ho == "Duongq" | data_ho$Ho == "Dươngquang" | data_ho$Ho == "DươngQuốc" | data_ho$Ho == "DươngThanh" | data_ho$Ho == "Duongthi" | data_ho$Ho == "Dươngthi" | data_ho$Ho == "DươngThi" | data_ho$Ho == "Dươngthij" | data_ho$Ho == "Duorng" | data_ho$Ho == "Dưowng" | data_ho$Ho == "Dưownh" | data_ho$Ho == "Dupng" | data_ho$Ho == "Dupwng" | data_ho$Ho == "Dươnv" | data_ho$Ho == "Duoqng" | data_ho$Ho == "Dưoqng" | data_ho$Ho == "Duorng" | data_ho$Ho == "Dưowng" | data_ho$Ho == "Dưownh" | data_ho$Ho == "Dupng" | data_ho$Ho == "Dupwng" | data_ho$Ho == "Dưưng" | data_ho$Ho == "Duương" | data_ho$Ho == "duương" | data_ho$Ho == "DUƯƠNG" | data_ho$Ho == "Duuwng" | data_ho$Ho == "Duwowng"), "Dương", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Duy|DUY|duy|Duỳ|Dùy") == TRUE, "Duy", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đường|Đường|ĐƯỜNG|Dướng|dường|Dường|Dường|Dưỡng|Dượng|Đương|Đường|Đường|Đuòng|Đuờng|ĐƯƠNG|đương|Đường|đường|ĐƯỜNG|Đừơng|Dươờng|Đươờng") == TRUE, "Đường", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Giang|giang|GIANG|Giangg|Gianh") == TRUE, "Giang", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "giàng|Giàng|Giàng|Giàng|GIÀNG|giàng|Giàng|Giầng|Giằng|Giằng|giằng|Gìang|Gìang|Giành|GIÀNH") == TRUE, "Giàng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Giap|giap|GIAP|Giáp|giáp|GIÁP|Giáp|giáp|GIÁP|Giâp|Giấp|Giắp|Gíap|Giápthi") == TRUE, "Giáp", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "H" | data_ho$Ho == "h"), "H", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "H'" | data_ho$Ho == "H’"), "H'", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "hà|Hà|Hà|HÀ|hà|Hà|HÀ|Haà|Haà") == TRUE, "Hà", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Hạ" | data_ho$Ho == "hạ" | data_ho$Ho == "Hạ" | data_ho$Ho == "HẠ" | data_ho$Ho == "HẠ"), "Hạ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hán|Hán|HÁN|hán|HÁN") == TRUE, "Hán", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hảng|HẢNG|Hảng|hảng|Hẳng|Hảnh") == TRUE, "Hảng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hạng|Hạng|HẠNG|hạng|Hặng|Hạnh") == TRUE, "Hạng", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "hồ|Hồ̀|HỒ|hồ|Hồ|Hồ|HỒ|Hoồ|hoồ|HOỒ|HoỒ|Hoồ|Hôồ|Hôồ") == TRUE, "Hồ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hờ|hờ|HỜ|Hờ|hờ") == TRUE, "Hờ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hoang|hoàng|hoàng|Hoàng|Hoàng|HOÀNG|Hoàng|HOÀNG|Hòang|Hoáng|HOàng|hòang|HÒANG|HÒANG|Hoành|HOÀNH|Haòng|Haongf|Hoaàng|Hoaàng|hoaàng|HOAÀNG|Hoaangf|Hoabgf|Hoàg|Hòag|Hoamg|Hoàmg|Hoamgf|Hoàng|Hoāng|Hoầng|Hoằng|Hoằng|HOẰNG|hoằng|Hòang|Hòàng|Hôàng|Hoanhg|Hoànng|Hoanngf|Hoanvf|Honàg|Hooàng|Hoòng|Hpàng|Hpangf") == TRUE, "Hoàng", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "HUNG" | data_ho$Ho == "Húng" | data_ho$Ho == "Húng" | data_ho$Ho == "Hùng" | data_ho$Ho == "hùng" | data_ho$Ho == "HÙNG" | data_ho$Ho == "hùng" | data_ho$Ho == "Hùng" | data_ho$Ho == "Hủng" | data_ho$Ho == "Hủng" | data_ho$Ho == "Hunh" | data_ho$Ho == "Hùnh" | data_ho$Ho == "Hùnh" | data_ho$Ho == "Hunhf"), "Hùng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Huynh|huỳnh|Huỳnh|Huỳnh|HuỲNH|HUỲNH|Hùynh|huỳnh|Huỳnh|HUỲNH|Huuỳnh|Huuỳnh|Huỳn|Huỳng|huynh|HUYNH|Huýnh|Huỳnh|Huỹnh|Huỷnh|hùynh|Hùynh|HÙYNH|Huyỳnh|Huunh|Huùnh|Hùunh|Huunhf|HUUỲNH|huuỳnh|Hùuynh|Hùuỳnh|Huyh|Huỳh|Hùyh|huyhn|Huyinh|Huymh|Huỳmh|Hùymh|Huymhf|Huyn|HUỲN|huỳn|Huỳn|HUỲNG|huỳng|Huỳng|Hùyng|Huyngf|Huyǹh|HUYÑH|Huýnh|HUÝNH|huýnh|Huỳnh|HUỸNH|huỹnh|huỷnh|HUỶNH|Huỷnh|Huỵnh|HUỴNH|huỵnh|Húynh|HÙYNH|Hùỳnh|Hūynh|Hủynh|Huynnh|Huỳuh|Huyunh|Huỳunh|HUYỲNH|Huyỳnh|Hynh|Hỳnh|HỲNH|Hyun|Hyunh|Hyùnh|Hỳunh|Hyunhf") == TRUE, "Huỳnh", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Húa|HÚA|Hưá|hưá|Hưá|Hưâ|Hứa|hứa|HỨA|Hứa|HỨA|hứa|Hừa|Hữa|Hữa|HỮA|hữa|Hửa|hửa") == TRUE, "Hứa", data_ho$Ho)
...
data_ho$Ho <- ifelse((data_ho$Ho == "K'" | data_ho$Ho == "k'" | data_ho$Ho == "K''" | data_ho$Ho == "K‘" | data_ho$Ho == "K’" | data_ho$Ho == "k’"), "K'", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kato|Katơ|Kator|Katơr|KaTơr|KATƠR") == TRUE, "Katơr", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khấu|Khấu|khấu|KHẤU|KHẤU|Khầu|Khẩu|Khẩu") == TRUE, "Khấu", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khuc|khúc|Khúc|Khúc|KHÚC") == TRUE, "Khúc", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khiến|Khieu|Khiêu|khiêu|KHIÊU|Khiếu|khiếu|KHIẾU|Khiếu|khiếu|Khiều") == TRUE, "Khiếu", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khoa|khoa|KHOA|Khỏa") == TRUE, "Khoa", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khổn|khổn|Khống|khống|Khỗng|Khỏng|Khổng|khổng|KHỔNG|Khổng|KHỔNG|khổng|KHổng|Khổnh|Khóong") == TRUE, "Khổng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khuấ|Khuat|Khuát|Khuât|Khuất|KHUẤT|khuất|Khuất|khuất|Khuẩt|Khuấy") == TRUE, "Khuất", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khươmg|Khuong|KHUONG|khuong|Khuông|khuông|Khuơng|Khưong|Khương|KHƯƠNG|khương|KHương|Khượng") == TRUE, "Khương", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Khuu|khuu|KHUU|Khuư|Khủu|Khưu|khưu|KHƯU|Khứu|Khứu|KHỨU|khứu|Khữu|Khựu") == TRUE, "Khưu", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "kieu|kiêu|KIÊU|Kiêù|Kiều|KiềU|kiều|KIều|Kiễu|Kiểu|KIỂU|kiểu|Kiệu") == TRUE, "Kiều", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kim|KIM|kim|KiM|Kím|Kìm|Kìm|Kịm") == TRUE, "Kim", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Ko|KO|Kô|KÔ|KƠ|Kơ|Kờ|KỜ") == TRUE, "Kơ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kpa|kpa|KPA|kPa|KPa|Kpa'|Kpá|KPá|KPÁ|Kpă|KPĂ|KPă|kpă|KpĂ|kPă|K'PĂ|K'pă|Kpã|KPã|KPÃ|KpÃ|Kpắ|KPắ|KPẮ|Kpắ|Kpả|Kpah|KPAH|Kpăh|KPĂH|Kpak|Kpan|Kpaw") == TRUE, "Kpă", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kpiih|Kpiuh|Kpuh|Kpui|kpui|Kpuih|KPUIH|kpuih|KPuih|Kpuil|Kpuoh|Kquih") == TRUE, "Kpuih", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kror|KROR|Kros|Ksir|Kso|KSO|KSo|Ksô|KSô|Ksơ|ksơ|K'Sơ|Ksoe|Ksoh|Ksok|KSOK|Ksol|Kson|kson|Ksor|KSOR|KSor|ksor|K'sor|K'SOR|K'Sor|Ksơr|KSƠR|KsƠr|ksơr|KSơr|Ksorh|KSORH|Ksorh'|Ksorr|Ksos|Ksot|Ksr|Ksro|Ksror|KSOR") == TRUE, "Ksor", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Lac|Lạc|LẠC|Lạc|lạc|LẠc|Lach") == TRUE, "Lạc", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "lại|Lại|LẠI|Lại|Lại|Laị|LẠI|Lah|Laị|Ląi|Lại|lại|LẠi|Lạị|Laij|Lain") == TRUE, "Lại", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Lam|lâm|Lâm|LÂM|LÂm|lam|LAM|Lâm|Lăm|LĂM|lăm|Lấm|Lầm|lầm|lầm|Lầm|LẦM|Laâm|laâm|LAÂM|Ĺâm") == TRUE, "Lâm", data_ho$Ho)
...
data_ho$Ho <- ifelse((data_ho$Ho == "la" | data_ho$Ho == "La" | data_ho$Ho == "LA"), "La", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "lã" | data_ho$Ho == "Lã" | data_ho$Ho == "LÃ" | data_ho$Ho == "Lả" | data_ho$Ho == "Lã" | data_ho$Ho == "lã" | data_ho$Ho == "LÃ" | data_ho$Ho == "Lẫ" | data_ho$Ho == "Lẵ" | data_ho$Ho == "Lả" | data_ho$Ho == "Lả" | data_ho$Ho == "lả" | data_ho$Ho == "Laã" | data_ho$Ho == "Lâ" | data_ho$Ho == "Lã" | data_ho$Ho == "Lã"), "Lã", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Le|lê|Lê|LÊ|le|LE|Lê|Lế|Lê|Lë|Lẽ|LẼ|lẽ|LẾ|Lề|lề|LỀ|Lễ|LỄ|lễ|Lẻ|lẻ|LẺ|Lể|LỂ|lể|Lệ|LỆ|lệ|Ĺê") == TRUE, "Lê", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Liẽu|Liếu|Liều|LIỀU|liều|Liều|Liễu|Liễu|liễu|LIỄU|LiỄU|LIỄU|liễu|Liẻu|Liểu|liểu|LIỂU|Liểu|Liệu|liệu|Liệu|LIỆU|Liew") == TRUE, "Liễu", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Lôc|lôc|LÔC|Lọc|lọc|LỌC|Lộc|lộc|LỘC|Lộc|LỘC") == TRUE, "Lộc", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Lú|LÚ|lú|Lù|LÙ|lù|Lù|LÙ") == TRUE, "Lù", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Lű" | data_ho$Ho == "Lủ" | data_ho$Ho == "Lư" | data_ho$Ho == "LƯ" | data_ho$Ho == "lư" | data_ho$Ho == "Lụ" | data_ho$Ho == "Lứ" | data_ho$Ho == "Lừ" | data_ho$Ho == "lừ" | data_ho$Ho == "Lừ" | data_ho$Ho == "LỪ" | data_ho$Ho == "lừ"), "Lư", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Lữ|LỮ|lữ|Lữ|LỮ|lữ|Lử|lử|LỬ|Lử|Lự|Lự|LỰ|lự") == TRUE, "Lữ", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Nong|nong|NONG|Nóng|Nòng|Nông|NÔNG|nông|Nống|Nồng|nồng|nồng|NỒNG|Nồng|Nơng|Nộng|Nôngthi|Nonh|Nônh|NÔNH|Nônng|Noong|Noông") == TRUE, "Nông", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Pham|phạm|Phạm|Phạm|PHẠM|PHẠM|Phaạm|pham|PHAM|phạm|Phạm|Phạm|PhạM|PhẠm|PHạm|PHạm|PHạm|Phặm|Phậm|Pahmj|Pạm|Pbam|Pbạm|Pbamj|Pgam|Pgamj|Phạ|phạ|Phạ|PHAẠM|phaạm|Phaạm|Phaạn|PhahmPhaim|Phajm|Phakm|PHAm|Phám|Phâm|Phăm|Phãm|Phąm|phąm|Phẫm|Phẵm|Phảm|Phạm|PhẠm|PHẬM|phậm") == TRUE, "Phạm", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "phan|Phan|PHAN|pHAN|Phan|Phhan") == TRUE, "Phan", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Phi|PHI|phi") == TRUE, "Phi", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Phí|PHÍ|phí|Phí|PHÍ|phí|Phì|Phỉ|Phị") == TRUE, "Phí", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Pho|Phó|phó|PHÓ|Phó|Phò") == TRUE, "Phó", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Phù" | data_ho$Ho == "PHÙ" | data_ho$Ho == "phù" | data_ho$Ho == "Phù"), "Phù", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "phùng|Phùng|Phùng|PHÙNG|Phùn|Phung|Phùng|Phủng|Phúng|phùng|Phùng|PHÙNG|Phừng|Phùmg|Phumgf|Phùng|PhùNg|PHùng|Phūng|Phũng|Phủng|phừng|Phừng|Phunh|Phunhf|Phuùng") == TRUE, "Phùng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Phươn|Phuong|phuong|Phuông|Phưong|Phương|PHƯƠNG|phương|Phường|Phưởng|Phượng|phượng|Phượng|Phươngthanh") == TRUE, "Phương", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Pinang|Pinăng") == TRUE, "Pinăng", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Quan" | data_ho$Ho == "quan" | data_ho$Ho == "QUAN"), "Quan", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Quaản|Quản|QUẢN|quản|Quản|QuẢN|QUẢN") == TRUE, "Quản", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "quách|Quách|Quách|QUÁCH|Quach|Quách|Qách|Qoách|Quác|quach|QUÁCH|Quách|Qúach|Qoach|qoách|Qoách|Quaách|QUACH|Quách|quách|QUách|Quàch|quàch|Quâch|Quăch|Quắch|Quảch|Quạch|Qúach|Quáh|Quoach|Quoách|QUOÁCH") == TRUE, "Quách", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Quang|quang|QUANG|Quangg|Quanh|Quoang") == TRUE, "Quang", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "quàng|quàng|Quàng|Quàng|QUÀNG|Quáng|Quàng|Quàng|quầng|Quầng|Quằng|Quoàng") == TRUE, "Quàng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Quãng|quãng|QUÃNG|Quãng|Quảng|Quảng|QUẢNG|quảng|QuẢNG|Quẳng") == TRUE, "Quảng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Quế|quế|QUẾ|Quế") == TRUE, "Quế", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Rah|RAH|RAh|Răh|Rạh|Rahlan|RahLan|RAHLAN|RaHlan|RaHLan|Rahlanh") == TRUE, "Rah", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Rkan|Rla|Rlah|Rlahlan|Rlam|Rlan|RLAN|RLan|R'Lan|Rlsn") == TRUE, "Rlan", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Rma|RMA|Rmag|Rmah|RMAH|RMah|rmah|R'Mah|R'mah|Rmăh|RmĂh|RMăh|RMĂH|Rmahh|RmahH'|Rmal|Rman|Rmanh|RMANH|Rnah") == TRUE, "Rmah", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sài|SÀI|Sãi|Sải|sải|SẢI|Sại") == TRUE, "Sài", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sái|SÁI|sái|Sái|SÁI") == TRUE, "Sái", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sàm|sàm|SÀM|Sầm|SẦM|sầm|Sầm|SẦM") == TRUE, "Sầm", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sồng|sồng|Sồng|SỒNG") == TRUE, "Sồng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sữ|sữ|SỮ|Sử|sử|SỬ|Sử|SỬ") == TRUE, "Sử", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Sùng|SÙNG|Sùng|sùng|SÙNG|sùng|Sừng|Sừng|Sùnh") == TRUE, "Sùng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "tạ|Tạ|Tạ|TẠ|tạ|Tạ|TẠ|Tạ|Tậ|Tặ") == TRUE, "Tạ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tân|TÂN|tân") == TRUE, "Tân", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tàn|TÀN|Tần|TẦN|tần|Tần|Tằn") == TRUE, "Tần", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tăng|TĂNG|tăng|Tăng̉") == TRUE, "Tăng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tắng|Tằng|tằng|Tằng|TẰNG|tằng|Tẳng|Tặng|Tặng|tặng|TẶNG") == TRUE, "Tằng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "TAO|tao|Táo|TÁO|Tào|TÀO|tào|TÀO|Tảo") == TRUE, "Tào", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tát|Tât|Tất|TẤT|tất|Tất|Tắt") == TRUE, "Tất", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thach|thạch|Thạch|Thạch|THẠCH|thạch|Thạch|THẠCH|Thaạch|Thạc|thạc|Thạc|thach|THACH|Thac̣h|Thách|Thách|thách|Thąch|Thạch|ThẠCH|ThạCh|Thặch|Tḥach|Thăchj|Thacj|Thạcnh|Thạh") == TRUE, "Thạch", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "thái|Thái|Thái|THÁI|Thái|THÁI|Thaí|thaí|THAÍ|Thái|TháI|Thâi|Thãi|Thấi|Thải|Thải|Thại|Thaia|Thaid|Thál") == TRUE, "Thái", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thấm|Thầm|Thẫm|Thảm|Thẩm|THẨM|Thẩm|thẩm|Thẳm|Thạm|Thậm") == TRUE, "Thẩm", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thân|thân|THÂN|Thăn") == TRUE, "Thân", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Then|Thèn|THÈN|Thèn|thèn|Thền|THỀN|Thền|Thèng") == TRUE, "Thèn", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Thi" | data_ho$Ho == "thi" | data_ho$Ho == "THI" | data_ho$Ho == "Thį" | data_ho$Ho == "Thii"), "Thi", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "thị|Thị|Thị|THỊ|Thiị|Thj") == TRUE, "Thị", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thía|Thíc|Thich|Thích|thích|THÍCH|Thích") == TRUE, "Thích", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thièu|Thiêù|Thiều|THIỀU|thiều|Thiều|THIỀU|thiều|ThiềU|Thìêu") == TRUE, "Thiều", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Thông|THÔNG|thông") == TRUE, "Thông", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tiền|tiền|TIỀN|Tiền|TIỀN|TiỀN") == TRUE, "Tiền", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tiet|Tiêt|TIÊT|Tiết|TIẾT|tiết|Tiết|TiẾT|TIẾT") == TRUE, "Tiết", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tieu|TIEU|Tiêu|TIÊU|tiêu") == TRUE, "Tiêu", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Tô" | data_ho$Ho == "TÔ" | data_ho$Ho == "tô" | data_ho$Ho == "Thį" | data_ho$Ho == "Thii"), "Tô", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "tống|Tống|TỐNG|Tống|Tống|TỐNG|tống|Tôống") == TRUE, "Tống", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Trà" | data_ho$Ho == "TRÀ" | data_ho$Ho == "trà" | data_ho$Ho == "Trà" | data_ho$Ho == "TRA" | data_ho$Ho == "TRà"), "Trà", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Trâ|trâ|trầ|TRẦ|Trầ|Traafn|Tran|Tràn|trần|trần|Trần|Trần|TRẦN|Trầ|Trằn|trân|Trân|TRÂN|Trần|TrầN|TrẦn|TRần|TRầN|TRẦN|tran|TRan|TRAN|tràn|Tràn|TRÀN|trấn|Trấn|TRẤN|Trần|trẫn|Trẫn|trẩn|Trẩn|Trận|TRẦ|Trầ|Traafn|Traan|Traàn|Traần|TRAẦN|traần|Traần|Tràần|Trâần|TRÂẦN|Trâần|trâần|Traanf|Trầm|TRẦM|trầm|TRẦm|TRẦM|Trâǹ|Trầ̀n") == TRUE, "Trần", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "triệu|Triệu|Triệu|TRIỆU|Trieu|Triêu|Triệu|Triêụ|triệu|TRIỆU|Triẹu|Triệu|TRiệu|Triệ|TRIỆ|TRIÊK|Triêk|triẹu|TRIẸU|Triệu|Trịêu|Trịệu") == TRUE, "Triệu", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Trinh|trinh|TRINH|TRINh|TRinh") == TRUE, "Trinh", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Trình|TRÌNH|trình|Trình|TRÌNH|TRìNH") == TRUE, "Trình", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "trịnh|Trịnh|Trịnh|TRỊNH|Trịnh|TRỊNH|Triịnh|TRIỊNH|Trịn|Tring|Trịng|Trĩnh|trịnh|Trịnh|TrịNh|TRịnh|Trinhj|Trịh|Trihj|Triinh|triịnh|Triịnh|TRIỊNH|Triinhj|Trijnh|Trịmh|Trimhj|Trinḥ|Trịnh|TrỊNH|TrỊnh|Trinhi|Trinhk|Trinhn|Trinj|Triong|Triowng|Trjnh|Trrịnh") == TRUE, "Trịnh", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Truong|trương|Trương|TRƯƠNG|truong|Trươ|Trươg|Trươmg|Trươn|TRUONG|truơng|Truơng|Trưong|Trưông|Trương|Trươnh|Truương|Truoeng|Trưoeng|Truog|Truơg|trươg|Truomg|trươmg|Truon|TRƯƠN|Truông|Truỏng|TRUỎNG|TRUƠNG|Trüöng|Trůòng|TRŮÖNG|Trůõng|Trůőng|Trủỏng|trưong|TRƯONG|trưông|Trưỏng|Trương|TRương|Truonh|TRƯƠNH|Trưoơng|Trưoqng|Trưowng|Trupng|Trưpng|Trupwng|Trưưng|Truuong|TRUƯƠNG|truương|Trưương|Truuwng") == TRUE, "Trương", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Từ|từ|TỪ|Từ|TỪ|từ") == TRUE, "Từ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tưỡng|Tưởng|Tưởng|TƯỞNG|tưởng|TƯỞNG|Tượng|Tửơng") == TRUE, "Tưởng", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Ung|ung|UNG") == TRUE, "Ung", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Uong|Uông|UÔNG|uông") == TRUE, "Uông", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Vòng|vòng|VÒNG|Vòng|VòNg|Voòng|VOÒNG|voòng|VoÒng|Voòng|Vòong|vòong|VÒONG|Vòong") == TRUE, "Vòng", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "vũ|Vũ|Vũ|VŨ|vũ|Vũ|Vủ|VŨ|Vū|vủ|VỦ|Vữ|VuThi|Vuthi|Vuu|VUU|vuu|Vuũ|Vuũ") == TRUE, "Vũ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "vừ|Vừ|Vừ|Vừ|VỪ") == TRUE, "Vừ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Vuong|Vương|VƯƠNG|vương|Vương|Vươn|vuong|Vuông|Vuơng|Vưong|Vương|Vươg|Vươmg|VUONG|Vuỏng|vuơng|Vương|Vuương") == TRUE, "Vương", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Xa" | data_ho$Ho == "XA" | data_ho$Ho == "xa"), "Xa", data_ho$Ho)
data_ho$Ho <- ifelse((data_ho$Ho == "Y" | data_ho$Ho == "y" | data_ho$Ho == "Y'" | data_ho$Ho == "y'" | data_ho$Ho == "Y’"), "Y", data_ho$Ho)
```

...
ggsave(filename = file.path("Ho Nguyen-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Tran-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Lê
...
ggsave(filename = file.path("Ho Le-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Du-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Dương
...
ggsave(filename = file.path("Ho Duong-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ly-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Đoàn
...
ggsave(filename = file.path("Ho Doan-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ngo-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Triệu
...
ggsave(filename = file.path("Ho Trieu-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Mạc
...
ggsave(filename = file.path("Ho Mac-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Phùng
...
ggsave(filename = file.path("Ho Phung-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Khúc
...
ggsave(filename = file.path("Ho Khuc-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Phạm
...
ggsave(filename = file.path("Ho Pham-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ho-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ton-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Bùi
...
ggsave(filename = file.path("Ho Bui-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Đào
...
ggsave(filename = file.path("Ho Dao-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Dinh-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Đỗ
...
ggsave(filename = file.path("Ho Do-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Hoàng
...
ggsave(filename = file.path("Ho Hoang-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Huỳnh
...
ggsave(filename = file.path("Ho Huynh-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Phan-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Quach-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Trinh-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Truong-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Vu-PerPop.jpeg"), width = 33, height = 49)
```
## Họ Võ
...
ggsave(filename = file.path("Ho Vo-PerPop.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Nguyen-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Tran-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Lê
...
ggsave(filename = file.path("Ho Le-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Du-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Dương
...
ggsave(filename = file.path("Ho Duong-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ly-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Đoàn
...
ggsave(filename = file.path("Ho Doan-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ngo-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Triệu
...
ggsave(filename = file.path("Ho Trieu-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Mạc
...
ggsave(filename = file.path("Ho Mac-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Phùng
...
ggsave(filename = file.path("Ho Phung-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Khúc
...
ggsave(filename = file.path("Ho Khuc-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Phạm
...
ggsave(filename = file.path("Ho Pham-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ho-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Ton-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Bui-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Đào
...
ggsave(filename = file.path("Ho Dao-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Dinh-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Đỗ
...
ggsave(filename = file.path("Ho Do-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Hoàng
...
ggsave(filename = file.path("Ho Hoang-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Huỳnh
...
ggsave(filename = file.path("Ho Huynh-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Phan
...
ggsave(filename = file.path("Ho Phan-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Quach-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Trinh-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Trương
...
ggsave(filename = file.path("Ho Truong-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("Ho Vu-PerArea.jpeg"), width = 33, height = 49)
```
## Họ Võ
...
ggsave(filename = file.path("Ho Vo-PerArea.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Nguyen-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Tran-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Lê
...
ggsave(filename = file.path("figures", "Le-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Du-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Dương
...
ggsave(filename = file.path("figures", "Duong-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ly-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Doan-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ngo-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Trieu-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Mac-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Phùng
...
ggsave(filename = file.path("figures", "Phung-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Khúc
...
ggsave(filename = file.path("figures", "Khuc-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Phạm
...
ggsave(filename = file.path("figures", "Pham-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ho-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ton-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Bùi
...
ggsave(filename = file.path("figures", "Bui-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Đào
...
ggsave(filename = file.path("figures", "Dao-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Dinh-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Đỗ
...
ggsave(filename = file.path("figures", "Do-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Hoàng
...
ggsave(filename = file.path("figures", "Hoang-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Huỳnh
...
ggsave(filename = file.path("figures", "Huynh-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Phan
...
ggsave(filename = file.path("figures", "Phan-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Quach-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Trinh-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Truong-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Vu-PerPop-River.jpeg"), width = 33, height = 49)
```
## Họ Võ
...
ggsave(filename = file.path("figures", "Vo-PerPop-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Nguyen-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Tran-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Lê
...
ggsave(filename = file.path("figures", "Le-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Du-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Dương
...
ggsave(filename = file.path("figures", "Duong-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ly-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Đoàn
...
ggsave(filename = file.path("figures", "Doan-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ngo-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Triệu
...
ggsave(filename = file.path("figures", "Trieu-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Mạc
...
ggsave(filename = file.path("figures", "Mac-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Phùng
...
ggsave(filename = file.path("figures", "Phung-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Khúc
...
ggsave(filename = file.path("figures", "Khuc-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Phạm
...
ggsave(filename = file.path("figures", "Pham-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ho-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Ton-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Bui-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Đào
...
ggsave(filename = file.path("figures", "Dao-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Dinh-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Đỗ
...
ggsave(filename = file.path("figures", "Do-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Hoàng
...
ggsave(filename = file.path("figures", "Hoang-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Huỳnh
...
ggsave(filename = file.path("figures", "Huynh-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Phan
...
ggsave(filename = file.path("figures", "Phan-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Quach-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Trinh-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Trương
...
ggsave(filename = file.path("figures", "Truong-PerArea-River.jpeg"), width = 33, height = 49)
```
...
ggsave(filename = file.path("figures", "Vu-PerArea-River.jpeg"), width = 33, height = 49)
```
## Họ Võ
...
ggsave(filename = file.path("figures", "Vo-PerArea-River.jpeg"), width = 33, height = 49)
```
...
```{r, message=FALSE, warning=FALSE}
tran_sf <- dat_sf %>% mutate(prop.tran=(sum(subset(., Ho=="Trần")[, "songuoi"])/sum(songuoi))*100) %>% filter(Ho=="Trần")
tran_f <- tran_sf %>% select(MAXA, MATINH, songuoi, pro.pop, geometry) %>% st_as_sf(crs = 4326)

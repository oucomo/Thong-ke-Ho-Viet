...
```{r load data}
path_ho = file.path("D:/Viet/Thống kê Họ Việt/", "DanhSach_Ho.sav") 
path_huyen = file.path("D:/Viet/Thống kê Họ Việt/", "Dm_Huyen.sav")
path_tinh = file.path("D:/Viet/Thống kê Họ Việt/", "Dm_Tinh.sav")
path_xa = file.path("D:/Viet/Thống kê Họ Việt/", "Dm_Xa.sav")

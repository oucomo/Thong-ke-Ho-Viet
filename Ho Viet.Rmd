...
# plot_gg(gg_mai, multicore = TRUE, raytrace = TRUE, width = 4, height = 7, 
#        scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)

plot_gg(gg_mai, multicore = TRUE, width = 4 ,height=7, fov = 70)
render_depth(focallength=100,focus=0.72)
render_movie("figures/3D/mai.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)
# render_snapshot(filename = "figures/3D/Mai.png", clear=T)
...
plot_gg(gg_mai, multicore = TRUE, width = 6 ,height=3, fov = 70)
render_depth(focallength=100,focus=0.72)
render_movie("figures/mai.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)
```
...
gg_mai = ggplot(mai_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=104.5, y=16, color="red", size=18, label= paste(round(mai_sff$prop.mai[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  theme(text = element_text(size=1200), axis.text.x = element_text(size=600), axis.text.y = element_text(size=600), legend.text=element_text(size=600), legend.key.size = unit(200, "cm")) +
  ggtitle("Họ Mai") +
  theme_bw()

plot_gg(gg_mai, multicore = TRUE, raytrace = F, width = 33, height =49, 
       scale = 1500, windowsize = c(11200, 6928), zoom = 0.6, phi = 30, theta = 30)
#render_depth(focallength=100,focus=0.72, filename = "figures/3D/Mai.png")
#render_movie("figures/3D/mai.mp4",frames = 1440, fps=60,zoom=0.6,fov = 30)
render_snapshot(filename = "figures/3D/Mai-HD.png", clear=T)

# Close the window when you're done
# rgl::rgl.close()
# render_highquality(filename = "figures/3D/Mai-HD.png", parallel = TRUE, samples = 300, intensity_env = 1.5, rotate_env = 180, width = round(6000 * wr), height = round(6000 * hr))
```
...
gg_phung = ggplot(phung_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(phung_sff$prop.phung[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Phùng") +
  theme_bw()

plot_gg(gg_phung, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Phung.png", clear=T)
```
...
gg_ngo = ggplot(ngo_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(ngo_sff$prop.ngo[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Ngô") +
  theme_bw()

plot_gg(gg_ngo, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Ngo.png", clear=T)
```
...
gg_khuc = ggplot(khuc_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(khuc_sff$prop.khuc[1],2), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Khúc") +
  theme_bw()

plot_gg(gg_khuc, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Khuc.png", clear=T)
```
...
gg_tran = ggplot(tran_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(tran_sff$prop.tran[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Trần") +
  theme_bw()

plot_gg(gg_tran, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Tran.png", clear=T)
```
...
gg_duong = ggplot(duong_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(duong_sff$prop.duong[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Dương") +
  theme_bw()

plot_gg(gg_duong, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Duong.png", clear=T)
```
...
gg_bui = ggplot(bui_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(bui_sff$prop.bui[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Bùi") +
  theme_bw()

plot_gg(gg_bui, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Bui.png", clear=T)
```
...
gg_dinh = ggplot(dinh_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(dinh_sff$prop.dinh[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Đinh") +
  theme_bw()

plot_gg(gg_dinh, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Dinh.png", clear=T)
```
...
gg_do = ggplot(do_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(do_sff$prop.do[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Đỗ") +
  theme_bw()

plot_gg(gg_do, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Do.png", clear=T)
```
...
gg_dao = ggplot(dao_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(dao_sff$prop.dao[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Đào") +
  theme_bw()

plot_gg(gg_dao, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Dao.png", clear=T)
```
...
gg_doan = ggplot(doan_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(doan_sff$prop.doan[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Đoàn") +
  theme_bw()

plot_gg(gg_doan, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Doan.png", clear=T)
```
...
gg_du = ggplot(du_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(du_sff$prop.du[1],2), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Dư") +
  theme_bw()

plot_gg(gg_du, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Du.png", clear=T)
```
...
gg_ho = ggplot(ho_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(ho_sff$prop.ho[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Hồ") +
  theme_bw()

plot_gg(gg_ho, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Ho.png", clear=T)
```
...
gg_hoang = ggplot(hoang_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(hoang_sff$prop.hoang[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Hoàng") +
  theme_bw()

plot_gg(gg_hoang, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Hoang.png", clear=T)
```
...
gg_huynh = ggplot(huynh_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(huynh_sff$prop.huynh[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Huỳnh") +
  theme_bw()

plot_gg(gg_huynh, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Huynh.png", clear=T)
```
...
gg_la = ggplot(la_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(la_sff$prop.la[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Lã") +
  theme_bw()

plot_gg(gg_la, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/La.png", clear=T)
```
...
gg_le = ggplot(le_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(le_sff$prop.le[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Lê") +
  theme_bw()

plot_gg(gg_le, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Le.png", clear=T)
```
...
gg_ly = ggplot(ly_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(ly_sff$prop.ly[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Lý") +
  theme_bw()

plot_gg(gg_ly, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Ly.png", clear=T)
```
...
gg_mac = ggplot(mac_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(mac_sff$prop.mac[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Mạc") +
  theme_bw()

plot_gg(gg_mac, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Mac.png", clear=T)
```
...
gg_nguyen = ggplot(nguyen_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(nguyen_sff$prop.nguyen[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Nguyễn") +
  theme_bw()

plot_gg(gg_nguyen, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Nguyen.png", clear=T)
```
...
gg_pham = ggplot(pham_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(pham_sff$prop.pham[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Phạm") +
  theme_bw()

plot_gg(gg_pham, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Pham.png", clear=T)
```
...
phan_sff <- dat_sff %>% 
  ...
  filter(Ho=="Phan") %>% 
  st_as_sf(crs = 4326)
gg_phan = ggplot(phan_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(phan_sff$prop.phan[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Phan") +
  theme_bw()

plot_gg(gg_phan, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Phan.png", clear=T)
```
...
gg_quach = ggplot(quach_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(quach_sff$prop.quach[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Quách") +
  theme_bw()

plot_gg(gg_quach, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Quach.png", clear=T)
```
...
gg_ton = ggplot(ton_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(ton_sff$prop.ton[1],2), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Tôn") +
  theme_bw()

plot_gg(gg_ton, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Ton.png", clear=T)
```
...
gg_trieu = ggplot(trieu_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(trieu_sff$prop.trieu[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Triệu") +
  theme_bw()

plot_gg(gg_trieu, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Trieu.png", clear=T)
```
...
gg_trinh = ggplot(trinh_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(trinh_sff$prop.trinh[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Trịnh") +
  theme_bw()

plot_gg(gg_trinh, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Trinh.png", clear=T)
```
...
gg_truong = ggplot(truong_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(truong_sff$prop.truong[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Trương") +
  theme_bw()

plot_gg(gg_truong, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Truong.png", clear=T)
```
...
gg_vi = ggplot(vi_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(vi_sff$prop.vi[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Vi") +
  theme_bw()

plot_gg(gg_vi, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Vi.png", clear=T)
```
...
gg_vo = ggplot(vo_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(vo_sff$prop.vo[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Võ") +
  theme_bw()

plot_gg(gg_vo, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Vo.png", clear=T)
```
...
gg_vu = ggplot(vu_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  annotate(geom="text", x=104.5, y=16, color="red", size=3, label= paste(round(vu_sff$prop.vu[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Vũ") +
  theme_bw()

plot_gg(gg_vu, multicore = TRUE, raytrace = TRUE, width = 7, height = 4, 
       scale = 300, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
...
render_snapshot(filename = "figures/3D/Vu.png", clear=T)
```

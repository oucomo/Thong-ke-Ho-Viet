...
ho_tinh_pop <- ho_tinh_pop %>%
  mutate(nguoi_pop=(songuoi/danso)*100)
...
## Convert back to a normal data.frame
vnm3_DF <- as.data.frame(vnm3)

vn3 = fortify(vnm3, regions="VARNAME_3")
head(vn3)

## Merge all data
dat <- vnm3_DF %>% right_join(xa2, by=c("NAME_1", "NAME_2", "NAME_3"))

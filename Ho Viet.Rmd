...
gg_mai = ggplot(mai_sff) +
  ...
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  theme(text = element_text(size=300), axis.text.x = element_text(size=240), axis.text.y = element_text(size=240), legend.text=element_text(size=240), legend.key.size = unit(20, "cm")) +
  ggtitle("Họ Mai") +
  theme_bw()

...
gg_mai = ggplot(mai_sff) +
  ...
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=104.5, y=16, color="red", size=7.5, label= paste(round(mai_sff$prop.mai[1],1), "% dân số", sep = "")) +
  annotate(geom="text", x=106, y=19.5, color="purple", size=2, label= mai_df[1,"NAME_3"]) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Họ Mai") +
  theme_bw() +
  theme(text = element_text(size=15), axis.text.x = element_text(size=15), axis.text.y = element_text(size=15), legend.text=element_text(size=15)) +
...
plot_gg(gg_mai, multicore = TRUE, raytrace = T, width = 10, height = 15, 
       scale = 500, windowsize = c(3500, 2165), zoom = 0.6, phi = 30, theta = 30)
rglwidget()
render_movie("figures/3D2/mai(2).mp4",frames = 720, fps=24,zoom=0.6,fov = 30)
# Close the window when you're done
rgl::rgl.close()
```
...
gg_mai = ggplot(mai_sff) +
  geom_sf(aes(fill = songuoi_km), lwd=0) +
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=104.5, y=16, color="red", size=15, label= paste(round(mai_sff$prop.mai[1],1), "% dân số", sep = "")) +
  annotate(geom="text", x=107, y=20, color="purple", size=10, label= mai_df[1,"NAME_3"]) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  theme(text = element_text(size=10000), axis.text.x = element_text(size=10000), axis.text.y = element_text(size=10000), legend.text=element_text(size=10000)) +
  ggtitle("Họ Mai") +
  theme_bw() +
...
plot_gg(gg_mai, multicore = TRUE, raytrace = T, width = 20, height = 30, 
       scale = 1000, windowsize = c(7000, 4330), zoom = 0.6, phi = 30, theta = 30)
rglwidget()
#render_depth(focallength=100,focus=0.72, filename = "figures/3D/Mai.png")

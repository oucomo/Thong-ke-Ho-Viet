...
data_ho_overall$songuoi <- na_if(data_ho_overall$songuoi, 0)
library(writexl)
...
data_ho_tinh <- data_ho %>%
  ...
  group_by(MATINH) %>%
  mutate(songuoi=na_if(songuoi, 0),
         danso=sum(songuoi)) %>% ungroup() %>%
...
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 1"), "Phuong 01", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 2"), "Phuong 02", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 3"), "Phuong 03", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 4"), "Phuong 04", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 5"), "Phuong 05", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 6"), "Phuong 06", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 7"), "Phuong 07", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 8"), "Phuong 08", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 9"), "Phuong 09", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 10"), "Phuong 10", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 11"), "Phuong 11", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 12"), "Phuong 12", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 13"), "Phuong 13", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 14"), "Phuong 14", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 15"), "Phuong 15", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 16"), "Phuong 16", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 17"), "Phuong 17", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 18"), "Phuong 18", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 19"), "Phuong 19", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 20"), "Phuong 20", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 21"), "Phuong 21", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 22"), "Phuong 22", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 23"), "Phuong 23", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 24"), "Phuong 24", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 25"), "Phuong 25", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 26"), "Phuong 26", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 27"), "Phuong 27", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 28"), "Phuong 28", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 29"), "Phuong 29", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 30"), "Phuong 30", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 31"), "Phuong 31", gadm_sf$NAME_3)
gadm_sf$NAME_3 <- ifelse((gadm_sf$NAME_3 == "Phuong Phuong 32"), "Phuong 32", gadm_sf$NAME_3)
...
dat_sf$songuoi <- na_if(dat_sf$songuoi, 0)
...
dat_sf$Ho[!(dat_sf$Ho %in% ho$Ho)] <- "Khác"
```
## Họ Nguyễn
...
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 1"), "Phuong 01", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 2"), "Phuong 02", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 3"), "Phuong 03", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 4"), "Phuong 04", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 5"), "Phuong 05", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 6"), "Phuong 06", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 7"), "Phuong 07", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 8"), "Phuong 08", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 9"), "Phuong 09", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 10"), "Phuong 10", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 11"), "Phuong 11", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 12"), "Phuong 12", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 13"), "Phuong 13", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 14"), "Phuong 14", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 15"), "Phuong 15", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 16"), "Phuong 16", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 17"), "Phuong 17", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 18"), "Phuong 18", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 19"), "Phuong 19", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 20"), "Phuong 20", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 21"), "Phuong 21", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 22"), "Phuong 22", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 23"), "Phuong 23", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 24"), "Phuong 24", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 25"), "Phuong 25", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 26"), "Phuong 26", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 27"), "Phuong 27", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 28"), "Phuong 28", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 29"), "Phuong 29", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 30"), "Phuong 30", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 31"), "Phuong 31", dat_f$NAME_3)
dat_f$NAME_3 <- ifelse((dat_f$NAME_3 == "Phuong Phuong 32"), "Phuong 32", dat_f$NAME_3)
...
dat_sff$Ho[!(dat_sff$Ho %in% ho$Ho)] <- "Khác"
head(dat_sff)
```
...
la_thaibinh <- la_thaibinh %>%
  mutate(centroid_0 = centroid[NAME_3=="Xa Dong Son" & NAME_2=="Dong Hung"],
         distm = geosphere::distGeo(st_coordinates(centroid), st_coordinates(centroid_0)),
         distm_km=distm/1000,
         distm_km2=distm_km^2,
         sum_distm_km2=sum(distm_km2),
...
la_thaibinh_data <- la_thaibinh %>%
  mutate(distm_km=round(as.numeric(distm_km), 2),
         lng = map(centroid,1),
         lat = map(centroid,2),
  ...
  arrange(distm_km) %>%
  st_drop_geometry() %>%
  select(NAME_1, NAME_2, NAME_3, songuoi, danso, pro.pop, area_km, songuoi_km, lng, lat, distm_km)

la_thaibinh_peak <- la_thaibinh %>% filter(NAME_3=="Xa Dong Son" & NAME_2=="Dong Hung")

# datatable(la_thaibinh_data, colnames = c("STT", "Tỉnh/Thành phố", "Quận/Huyện", "Phường/Xã", "Số người", "Dân số", "Tỉ lệ/xã phường", "Diện tích (km2)", "Mật độ (người/km2)", "Kinh độ", "Vĩ độ", "Khoảng cách tới tâm (km)"), extensions = 'Buttons', options = list(
#     dom = 'Bfrtip',
...
ggplot() + geom_sf() + geom_sf(data=la_thaibinh, aes(fill=pro.pop), color=NA) +
  geom_sf_label(data=la_thaibinh_peak, mapping = aes(label=NAME_3), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
...
pro.pop<-la_thaibinh_radius$pro.pop
rank<-la_thaibinh_radius$rank
commune<-la_thaibinh_radius$NAME_3
rank<-factor(rank, labels = commune)
estimate<-8*exp(-(distm_km^2)/(2*100))
...
plot_df
ggsave(filename = file.path("figures", "General", "La-Thai Binh.jpeg"), width = 25, height = 16)
```
...
gg_la_thaibinh = ggplot(la_thaibinh) +
  geom_sf(aes(fill = songuoi_km)) +
  geom_sf_label(data=la2_peak, mapping = aes(label="Đông Sơn, Đông Hưng"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Mật độ người/km2", direction = -1, option = "viridis") +
  ggtitle("Lã-Thái Bình") +
  theme_bw() +
  theme(text = element_text(size=22), axis.text.x = element_text(size=15), axis.text.y = element_text(size=15), legend.text=element_text(size=15), legend.key.size = unit(1, "cm"), plot.title = element_text(size = 22))
ggsave(filename = file.path("figures", "La-Thai Binh.png"), width = 25, height = 16)

plot_gg(gg_la_thaibinh, multicore = TRUE, width = 6 ,height=3, fov = 70)
render_depth(focallength=100,focus=0.72)
render_movie("figures/la_thaibinh.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)

plot_gg(gg_la_thaibinh
             , width = 3.5
             , height = 3.5
             , sunangle = 225
             )
...
rgl::rglwidget()
plot_gg(gg_la_thaibinh, width = 7.5, height = 7.5, 
       scale = 150, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
# render_snapshot(filename = "figures/la_thaibinh_3D.png", clear=T)
render_movie("figures/la_thaibinh.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)
rgl::rgl.close()
```
...
la2_peak <- la2_plot %>% filter(NAME_3=="Xa Dong Son" & NAME_2=="Dong Hung")
library(writexl)
write_xlsx(la2, "figures/la.xlsx")
```
...
ggplot() + geom_sf() + geom_sf(data=la2_plotf, aes(fill=songuoi_km), color=NA) +
  ...
  geom_sf_label(data=la2_peak, mapping = aes(label="Đông Hưng, Thái Bình"), color="red", size=7, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  annotate(geom="text", x=108, y=23, color="red", size=10, label= paste(round(la2_plotf$prop.la2[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Mật độ (người/km2)", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=30), axis.text.x = element_text(size=20), axis.text.y = element_text(size=20), legend.text=element_text(size=20), legend.key.size = unit(1.5, "cm"), plot.title = element_text(size = 40)) +
  ggtitle("Lã")
ggsave(filename = file.path("figures", "La.png"), width = 16, height = 25)
```
...
save(dat_f, dat_sf, dat_sff, data_ho, data_ho_overall, data_ho_tinh, data_ho_xa, data_huyen, data_tinh, data_xa, river3, file = "data/hoviet_full.RData")
```
...
gg_mai = ggplot(mai_sff) +
  ...
  geom_sf(data=river3, col="white") +
  annotate(geom="text", x=104.5, y=16, color="red", size=7.5, label= paste(round(mai_sff$prop.mai[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Tỉ lệ (%)/dân số", direction = -1, option = "viridis") +
  ggtitle("Họ Mai") +
  theme_bw() +
  theme(text = element_text(size=15), axis.text.x = element_text(size=15), axis.text.y = element_text(size=15), legend.text=element_text(size=15)) +
  theme(legend.key.height = unit(10, "mm"),
...
plot_gg(gg_ma, multicore = TRUE, raytrace = T, width = 10, height = 15, 
        scale = 300, windowsize = c(3500, 2165), zoom = 0.6, phi = 30, theta = 30)
#render_depth(focallength=100,focus=0.72, filename = "figures/3D/Ma.png")
#render_movie("figures/3D/ma.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)
#render_snapshot(filename = "figures/3D/Ma.png", clear=T)
...
```{r, message=FALSE, warning=FALSE}
ma2_peak1 <- ma2 %>% filter(distm_km<101)
sum(ma2_peak1$songuoi)/sum(ma2$songuoi)

ma2_peak2 <- ma2_plot %>%
  mutate(centroid_0 = centroid[NAME_3=="Xa Van Mon" & NAME_2=="Yen Phong"],
         distm = geosphere::distGeo(st_coordinates(centroid), st_coordinates(centroid_0)),
         distm_km=distm/1000,
         distm_km=round(as.numeric(distm_km), 2),
         lng = map(centroid,1),
...
ma2_peak2 <- ma2_peak2 %>% filter(distm_km<101)
sum(ma2_peak2$songuoi)/sum(ma2$songuoi)

ma2_peak3 <- ma2_plot %>%
  mutate(centroid_0 = centroid[NAME_3=="Xa Huc Dong" & NAME_2=="Binh Lieu"],
         distm = geosphere::distGeo(st_coordinates(centroid), st_coordinates(centroid_0)),
         distm_km=distm/1000,
         distm_km=round(as.numeric(distm_km), 2),
=======
...
#render_movie("figures/3D/ma.mp4",frames = 720, fps=30,zoom=0.6,fov = 30)
#render_snapshot(filename = "figures/3D/Ma.png", clear=T)
render_snapshot(filename = "figures/3D2/Ma-PerPop(1).png", clear = T)
...
```{r, warning=FALSE, message=FALSE, lazy=FALSE}
ma_ngason <- dat_sff %>% filter(Ho=="Mã" & NAME_1=="Thanh Hoa") %>% st_as_sf(crs = 4326)
ma_ngason$centroid <- sf::st_transform(ma_ngason, 2154) %>% 
  st_centroid() %>% 
  # this is the crs from d, which has no EPSG code:
  st_transform(., '+proj=longlat +ellps=GRS80 +no_defs') %>%
  # since you want the centroids in a second geometry col:
...
ma_ngason_data <- ma_ngason %>%
  mutate(distm_km=round(as.numeric(distm_km), 2),
>>>>>>> 86994d8a7578395be63767ecb441bfbd6ec7be57
         lng = map(centroid,1),
         lat = map(centroid,2),
         lng = round(as.numeric(lng), 2),
         lat = round(as.numeric(lat), 2),
...
ma2_peak3 <- ma2_peak3 %>% filter(distm_km<101)
sum(ma2_peak3$songuoi)/sum(ma2$songuoi)
```

```{r, message=FALSE, warning=FALSE}
ma21 <- dat_sff %>% filter(Ho=="Mã") %>% st_as_sf(crs = 4326)
ma21$centroid <- sf::st_transform(ma21, 2154) %>% 
=======
  select(NAME_1, NAME_2, NAME_3, songuoi, danso, pro.pop, area_km, songuoi_km, lng, lat, distm_km)

ma_ngason_peak <- ma_ngason %>% filter(NAME_3=="Xa Nga Thach" & NAME_2=="Nga Son")
```

```{r, warning=FALSE, message=FALSE, lazy=TRUE}
ggplot() + geom_sf() + geom_sf(data=ma_ngason, aes(fill=pro.pop), color=NA) +
  geom_sf_label(data=ma_ngason_peak, mapping = aes(label="Nga Thạch"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Tỉ lệ (%)", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm"), plot.title = element_text(size = 45)) +
  ggtitle("Mã-Nga Sơn")
ggsave(filename = file.path("figures", "3D2", "Ma-Nga Son.png"), width = 25, height = 16)
```
...
gg_ma_ngason = ggplot(ma_ngason) +
  geom_sf(aes(fill = pro.pop)) +
  geom_sf_label(data=ma_ngason_peak, mapping = aes(label="Nga Thạch"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Tỉ lệ (%)", direction = -1, option = "viridis") +
  ggtitle("Mã-Nga Sơn") +
  theme_bw() +
...
plot_gg(gg_ma_ngason, width = 7.5, height = 7.5, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
render_snapshot(filename = "figures/3D2/Ma-Nga Son-3D.png", clear = T)
rgl::rgl.close()
```
...
```{r, warning=FALSE, message=FALSE, lazy=FALSE}
ma_bacninh <- dat_sff %>% filter(Ho=="Mã" & NAME_1=="Bac Ninh") %>% st_as_sf(crs = 4326)
ma_bacninh$centroid <- sf::st_transform(ma_bacninh, 2154) %>% 
>>>>>>> 86994d8a7578395be63767ecb441bfbd6ec7be57
  st_centroid() %>% 
  # this is the crs from d, which has no EPSG code:
  st_transform(., '+proj=longlat +ellps=GRS80 +no_defs') %>%
...
distm_km<-ma21_radius$distm_km
pro.pop<-ma21_radius$pro.pop
rank<-ma21_radius$rank
commune<-ma21_radius$NAME_3
rank<-factor(rank, labels = commune)
estimate<-10*exp(-(distm_km^2)/(2*30))
...
plot_df <- df %>%
  ...
  theme(panel.grid.major = element_blank()) + 
  annotate(geom='text', x=120, y=5, label="y == 10*e^-{(x^{2}+y^{2})/2*(30)}", parse = TRUE,size=15) +
  annotate(geom='text', x=120, y=4.5, label="s.e. = 1%/xã",parse=F,size=12) +
  #coord_flip() +
  ggtitle("Mã-Bắc Ninh")
...
ma22 <- dat_sff %>% filter(Ho=="Mã") %>% st_as_sf(crs = 4326)
ma22$centroid <- sf::st_transform(ma22, 2154) %>% 
=======
ma_bacninh_data <- ma_bacninh %>%
  mutate(distm_km=round(as.numeric(distm_km), 2),
         lng = map(centroid,1),
         lat = map(centroid,2),
         lng = round(as.numeric(lng), 2),
...
ma_bacninh_peak <- ma_bacninh %>% filter(NAME_3=="Thi tran Cho" & NAME_2=="Yen Phong")
```

```{r, warning=FALSE, message=FALSE, lazy=TRUE}
ggplot() + geom_sf() + geom_sf(data=ma_bacninh, aes(fill=pro.pop), color=NA) +
  geom_sf_label(data=ma_bacninh_peak, mapping = aes(label="Thị trấn Chờ"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Tỉ lệ (%)", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm"), plot.title = element_text(size = 45)) +
  ggtitle("Mã-Bắc Ninh")
ggsave(filename = file.path("figures", "3D2", "Ma-Bac Ninh.png"), width = 25, height = 16)
```

## Họ Mã - Hà Cối

```{r, warning=FALSE, message=FALSE, lazy=FALSE}
ma_hacoi <- dat_sff %>% filter(Ho=="Mã") %>% st_as_sf(crs = 4326)
ma_hacoi$centroid <- sf::st_transform(ma_hacoi, 2154) %>% 
>>>>>>> 86994d8a7578395be63767ecb441bfbd6ec7be57
  st_centroid() %>% 
  # this is the crs from d, which has no EPSG code:
  st_transform(., '+proj=longlat +ellps=GRS80 +no_defs') %>%
...
ma_hacoi <- ma_hacoi %>%
>>>>>>> 86994d8a7578395be63767ecb441bfbd6ec7be57
  mutate(centroid_0 = centroid[NAME_3=="Xa Dong Thang" & NAME_2=="Dinh Lap"],
         distm = geosphere::distGeo(st_coordinates(centroid), st_coordinates(centroid_0)),
         distm_km=distm/1000,
         distm_km2=distm_km^2,
         sum_distm_km2=sum(distm_km2),
...
distm_km<-ma22_radius$distm_km
pro.pop<-ma22_radius$pro.pop
rank<-ma22_radius$rank
commune<-ma22_radius$NAME_3
rank<-factor(rank, labels = commune)
estimate<-5*exp(-(distm_km^2)/(2*40))
...
plot_df <- df %>%
  ...
  theme(text = element_text(size=40), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size=30),
        legend.text=element_text(size=30), legend.key.size = unit(6, "cm"), legend.key.height = unit(2, "cm"), legend.key.width = unit(2, "cm"), legend.position = "bottom") +
  theme(panel.grid.major = element_blank()) + 
  annotate(geom='text', x=30, y=4, label="y == 5*e^-{(x^{2}+y^{2})/2*(40)}", parse = TRUE,size=15) +
  annotate(geom='text', x=30, y=3.8, label="s.e. = 1%/xã",parse=F,size=12) +
  #coord_flip() +
  ggtitle("Mã-Hà Cối")
...
rank<-factor(rank, labels = commune)
area_km<-ma2_radius$area_km
songuoi_km<-ma2_radius$songuoi_km
pro.pop_km<-ma2_radius$pro.pop_km
...
fit1 <- ols(pro.pop ~ rcs(distm_km, 3) + area_km, data = df)
fit1
anova(fit1)
...
ma_hacoi_peak <- ma_hacoi %>% filter(NAME_3=="Xa Dong Thang" & NAME_2=="Dinh Lap")
```

```{r, warning=FALSE, message=FALSE, lazy=TRUE}
ggplot() + geom_sf() + geom_sf(data=ma_hacoi, aes(fill=pro.pop), color=NA) +
  geom_sf_label(data=ma_hacoi_peak, mapping = aes(label="Đồng Thắng"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Tỉ lệ (%)", direction = -1, option = "viridis") +
  theme_bw() +
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm"), plot.title = element_text(size = 45)) +
  ggtitle("Mã-Hà Cối")
ggsave(filename = file.path("figures", "3D2", "Ma-Ha Coi.png"), width = 25, height = 16)
```
...
gg_ma_hacoi = ggplot(ma_hacoi) +
  geom_sf(aes(fill = pro.pop)) +
  geom_sf_label(data=ma_hacoi_peak, mapping = aes(label="Húc Động"), color="red", size=6, stat = "sf_coordinates", hjust=-0.1, vjust=1, label.size = 0.5) +
  scale_fill_viridis("Tỉ lệ (%)", direction = -1, option = "viridis") +
  ggtitle("Mã-Hà Cối") +
  theme_bw() +
  theme(text = element_text(size=15), axis.text.x = element_text(size=15), axis.text.y = element_text(size=15), legend.text=element_text(size=15)) +
...
plot_gg(gg_ma_hacoi, width = 7.5, height = 7.5, windowsize = c(1400, 866), zoom = 0.6, phi = 30, theta = 30)
render_snapshot(filename = "figures/3D2/Ma-Ha Coi-3D.png", clear = T)
rgl::rgl.close()
>>>>>>> 86994d8a7578395be63767ecb441bfbd6ec7be57
```
...
dat1 <- dat %>% filter(Ho %in% c("Dương", "Lê", "Mai", "Ngô", "Nguyễn", "Phùng", "Trần", "Chử"))

dat10 <- dat %>% filter(Ho %in% c("Mai", "Chu", "Phùng", "Dương", "Ngô", "Lương", "Lý", "Hoàng", "Trần", "Lê"))
...
```{r}
dat_plot <- dat_sff %>% select(NAME_1, NAME_2, NAME_3, Ho, songuoi, danso, pro.pop, area_km, songuoi_km, geometry) %>% st_as_sf(crs = 4326)
dat_plot$centroid <- sf::st_transform(dat_plot, 2154) %>% 
  st_centroid() %>% 
  # this is the crs from d, which has no EPSG code:
  st_transform(., '+proj=longlat +ellps=GRS80 +no_defs') %>%
  # since you want the centroids in a second geometry col:
...
dat <- dat_plot %>%
  mutate(lng = map(centroid,1),
         ...
         songuoi_km=as.numeric(round(songuoi_km, 2))) %>%
  st_drop_geometry() %>%
  select(NAME_1, NAME_2, NAME_3, Ho, songuoi, danso, pro.pop, area_km, songuoi_km, lng, lat)

library(writexl)
write_xlsx(dat, "dat.xlsx")
# datatable(dat, colnames = c("STT", "Tỉnh/Thành phố", "Quận/Huyện", "Phường/Xã", "Họ", "Số người", "Dân số", "Tỉ lệ/xã phường", "Diện tích (km2)", "Mật độ (người/km2)", "Kinh độ", "Vĩ độ"))
```

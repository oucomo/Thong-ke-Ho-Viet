...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đàm|Đàm|ĐÀM|Đàm|Đàm|đàm|Dam|DAM|dam|Dám|Dàm|dàm|Đam||đam|ĐAM|Đám|Đám|Đàm|ĐÀM|Ðàm|Đamg|") == TRUE, "Đàm", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "HUNG|Húng|Húng|Hùng|hùng|HÙNG|hùng|Hùng|Hủng|Hủng|Hunh|Hùnh|Hùnh|Hunhf") == TRUE, "Hùng", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Hua|hua|HUA|Húa|HÚA|Hưá|hưá|Hưá|Hưâ|Hứa|hứa|HỨA|Hứa|HỨA|hứa|Hừa|Hữa|Hữa|HỮA|hữa|Hửa|hửa") == TRUE, "Hứa", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Trà|TRÀ|trà|Trà|TRÀ|TRà") == TRUE, "Trà", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Tran|Tràn|trần|trần|Trần|Trần|TRẦN|Trầ|Trằn|trân|Trân|TRÂN|Trần|TrầN|TrẦn|TRần|TRầN|TRẦN|tran|TRan|TRAN|Trán|Trán|tràn|Tràn|TRÀN|Trăn|trấn|Trấn|TRẤN|Trần|trẫn|Trẫn|trẩn|Trẩn|Trận|TRẦ|Trầ|Traafn|Traan|Traàn|Traần|TRAẦN|traần|Traần|Tràần|Trâần|TRÂẦN|Trâần|trâần|Traanf|Trầm|TRẦM|trầm|TRẦm|TRẦM|Trâǹ|Trầ̀n") == TRUE, "Trần", data_ho$Ho)

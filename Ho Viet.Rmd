...
tran_namdinh <- tran_namdinh %>%
  mutate(centroid_0 = centroid[NAME_3=="Phuong Loc Vuong"],
         distm = geosphere::distm(centroid, centroid_0, fun = distHaversine))
distm(c(lon1, lat1), c(lon2, lat2), fun = distHaversine)

tran_namdinh <- tran_namdinh %>%
  mutate(distm = geosphere::distm(x = st_coordinates(centroid), y = st_coordinates(centroid), fun = geosphere::distHaversine))
```

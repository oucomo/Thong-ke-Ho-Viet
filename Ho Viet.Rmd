...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Kror|KROR|Kros|Ksir|Kso|KSO|KSo|Ksô|KSô|Ksơ|ksơ|K'Sơ|Ksoe|Ksoh|Ksok|KSOK|Ksol|Kson|kson|Ksor|KSOR|KSor|ksor|K'sor|K'SOR|K'Sor|Ksơr|KSƠR|KsƠr|ksơr|KSơr|Ksorh|KSORH|Ksorh'|Ksorr|Ksos|Ksot|Ksr|Ksro|Ksror") == TRUE, "Ksor", data_ho$Ho)
...
data_ho$Ho <- ifelse((data_ho$Ho == "lã" | data_ho$Ho == "Lã" | data_ho$Ho == "LÃ" | data_ho$Ho == "Lả" | data_ho$Ho == "Lã" | data_ho$Ho == "lã" | data_ho$Ho == "LÃ" | data_ho$Ho == "Lẫ" | data_ho$Ho == "Lẵ" | data_ho$Ho == "Lả" | data_ho$Ho == "Lả" | data_ho$Ho == "lả" | data_ho$Ho == "Laã"), "Lã", data_ho$Ho)

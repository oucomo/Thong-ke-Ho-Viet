...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Do|Đô|đỗ|Đỗ|Đỗ|ĐỖ|Đổ|ĐỖ") == TRUE, "Đỗ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "đoàn|Đoàn|Đoàn|ĐOÀN") == TRUE, "Đoàn", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "dư|Dư|DƯ|Dừ") == TRUE, "Dư", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Ha|hà|Hà|Hà|HÀ|hà|Hà|HÀ") == TRUE, "Hà", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Nguễn|Nguyễ|Nhuyễn|nguyen|Nguyen|NGUYEN|Nguyên|Nguyến|Nguyền|nguyễn|nguyễn|Nguyễn|Nguyễn|NguyễN|NguyỄn|NGUYỄN|NGUYỄN|Nguyển|Nguỹen|Ngyễn|Nguyê|Nguyêễn|nguyên|NGUYÊN|Nguyêñ|Nguyễn|nguyển|NGUYỂN|Nguyện|Nguỹên") == TRUE, "Nguyễn", data_ho$Ho)
...
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Vo|võ|Võ|Võ|VÕ|Vỏ|Vỗ|võ|Võ|VÕ|vỏ") == TRUE, "Võ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Vu|vũ|Vũ|Vũ|VŨ|vũ|Vũ|Vủ") == TRUE, "Vũ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "vừ|Vừ|Vừ|Vừ|VỪ") == TRUE, "Vừ", data_ho$Ho)
data_ho$Ho <- ifelse(str_detect(data_ho$Ho, "Vương|VƯƠNG|vương|Vương|Vưu") == TRUE, "Vương", data_ho$Ho)
```
...
ggplot() + geom_sf() + geom_sf(data=ton_plot, aes(fill=pro.pop), lwd=0) +
  annotate(geom="text", x=108, y=23, color="red", size=18, label= paste(round(ton_plot$prop.ton[1],1), "% dân số", sep = "")) +
  scale_fill_viridis("Tỉ lệ (%) trên dân số địa phương", direction = -1, option = "viridis") +
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Tôn")
...
ggplot() + geom_sf() + geom_sf(data=nguyen_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Nguyễn")
ggsave(filename = file.path("figures", "Ho Nguyen-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Nguyen-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=tran_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trần")
ggsave(filename = file.path("figures", "Ho Tran-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Tran-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Lê
...
ggplot() + geom_sf() + geom_sf(data=le_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Lê")
ggsave(filename = file.path("figures", "Ho Le-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Le-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=du_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Dư")
ggsave(filename = file.path("figures", "Ho Du-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Du-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Dương
...
ggplot() + geom_sf() + geom_sf(data=duong_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Dương")
ggsave(filename = file.path("figures", "Ho Duong-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Duong-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=ly_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Lý")
ggsave(filename = file.path("figures", "Ho Ly-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ly-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf(data=doan_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đoàn")
ggsave(filename = file.path("figures", "Ho Doan-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Doan-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf(data=ngo_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Ngô")
ggsave(filename = file.path("figures", "Ho Ngo-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ngo-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=trieu_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Triệu")
ggsave(filename = file.path("figures", "Ho Trieu-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Trieu-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=mac_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Mạc")
ggsave(filename = file.path("figures", "Ho Mac-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Mac-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Phùng
...
ggplot() + geom_sf() + geom_sf(data=phung_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phùng")
ggsave(filename = file.path("figures", "Ho Phung-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Phung-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Khúc
...
ggplot() + geom_sf() + geom_sf(data=khuc_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Khúc")
ggsave(filename = file.path("figures", "Ho Khuc-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Khuc-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Phạm
...
ggplot() + geom_sf() + geom_sf(data=pham_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phạm")
ggsave(filename = file.path("figures", "Ho Pham-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Pham-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=ho_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Hồ")
ggsave(filename = file.path("figures", "Ho Ho-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ho-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=ton_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Tôn")
ggsave(filename = file.path("figures", "Ho Ton-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ton-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Bùi
...
ggplot() + geom_sf() + geom_sf(data=bui_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Bùi")
ggsave(filename = file.path("figures", "Ho Bui-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Bui-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Đào
...
ggplot() + geom_sf() + geom_sf(data=dao_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đào")
ggsave(filename = file.path("figures", "Ho Dao-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Dao-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=dinh_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đinh")
ggsave(filename = file.path("figures", "Ho Dinh-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Dinh-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Đỗ
...
ggplot() + geom_sf() + geom_sf(data=do_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đỗ")
ggsave(filename = file.path("figures", "Ho Do-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Do-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Hoàng
...
ggplot() + geom_sf() + geom_sf(data=hoang_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Hoàng")
ggsave(filename = file.path("figures", "Ho Hoang-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Hoang-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Huỳnh
...
ggplot() + geom_sf() + geom_sf(data=huynh_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Huỳnh")
ggsave(filename = file.path("figures", "Ho Huynh-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Huynh-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Phan
...
ggplot() + geom_sf() + geom_sf(data=phan_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phan")
ggsave(filename = file.path("figures", "Ho Phan-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Phan-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=trinh_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trịnh")
ggsave(filename = file.path("figures", "Ho Trinh-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Trinh-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=truong_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trương")
ggsave(filename = file.path("figures", "Ho Truong-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Truong-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=vu_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Vũ")
ggsave(filename = file.path("figures", "Ho Vu-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Vu-PerPop-River.jpeg"), width = 49, height = 33)
```
## Họ Võ
...
ggplot() + geom_sf() + geom_sf(data=vo_plot, aes(fill=pro.pop), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Võ")
ggsave(filename = file.path("figures", "Ho Vo-PerPop-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Vo-PerPop-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=nguyen_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Nguyễn")
ggsave(filename = file.path("figures", "Ho Nguyen-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Nguyen-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=tran_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trần")
ggsave(filename = file.path("figures", "Ho Tran-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Tran-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Lê
...
ggplot() + geom_sf() + geom_sf(data=le_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Lê")
ggsave(filename = file.path("figures", "Ho Le-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Le-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=du_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Dư")
ggsave(filename = file.path("figures", "Ho Du-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Du-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Dương
...
ggplot() + geom_sf() + geom_sf(data=duong_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Dương")
ggsave(filename = file.path("figures", "Ho Duong-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Duong-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=ly_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Lý")
ggsave(filename = file.path("figures", "Ho Ly-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ly-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Đoàn
...
ggplot() + geom_sf(data=doan_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đoàn")
ggsave(filename = file.path("figures", "Ho Doan-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Doan-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf(data=ngo_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Ngô")
ggsave(filename = file.path("figures", "Ho Ngo-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ngo-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Triệu
...
ggplot() + geom_sf() + geom_sf(data=trieu_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Triệu")
ggsave(filename = file.path("figures", "Ho Trieu-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Trieu-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Mạc
...
ggplot() + geom_sf() + geom_sf(data=mac_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Mạc")
ggsave(filename = file.path("figures", "Ho Mac-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Mac-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Phùng
...
ggplot() + geom_sf() + geom_sf(data=phung_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phùng")
ggsave(filename = file.path("figures", "Ho Phung-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Phung-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Khúc
...
ggplot() + geom_sf() + geom_sf(data=khuc_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Khúc")
ggsave(filename = file.path("figures", "Ho Khuc-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Khuc-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Phạm
...
ggplot() + geom_sf() + geom_sf(data=pham_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phạm")
ggsave(filename = file.path("figures", "Ho Pham-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Pham-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=ho_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Hồ")
ggsave(filename = file.path("figures", "Ho Ho-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Ho-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Bùi
...
ggplot() + geom_sf() + geom_sf(data=bui_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Bùi")
ggsave(filename = file.path("figures", "Ho Bui-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Bui-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Đào
...
ggplot() + geom_sf() + geom_sf(data=dao_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đào")
ggsave(filename = file.path("figures", "Ho Dao-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Dao-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=dinh_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đinh")
ggsave(filename = file.path("figures", "Ho Dinh-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Dinh-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Đỗ
...
ggplot() + geom_sf() + geom_sf(data=do_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Đỗ")
ggsave(filename = file.path("figures", "Ho Do-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Do-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Hoàng
...
ggplot() + geom_sf() + geom_sf(data=hoang_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Hoàng")
ggsave(filename = file.path("figures", "Ho Hoang-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Hoang-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Huỳnh
...
ggplot() + geom_sf() + geom_sf(data=huynh_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Huỳnh")
ggsave(filename = file.path("figures", "Ho Huynh-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Huynh-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Phan
...
ggplot() + geom_sf() + geom_sf(data=phan_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Phan")
ggsave(filename = file.path("figures", "Ho Phan-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Phan-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Trịnh
...
ggplot() + geom_sf() + geom_sf(data=trinh_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trịnh")
ggsave(filename = file.path("figures", "Ho Trinh-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Trinh-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Trương
...
ggplot() + geom_sf() + geom_sf(data=truong_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Trương")
ggsave(filename = file.path("figures", "Ho Truong-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Truong-PerArea-River.jpeg"), width = 49, height = 33)
```
...
ggplot() + geom_sf() + geom_sf(data=vu_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Vũ")
ggsave(filename = file.path("figures", "Ho Vu-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Vu-PerArea-River.jpeg"), width = 49, height = 33)
```
## Họ Võ
...
ggplot() + geom_sf() + geom_sf(data=vo_plotf, aes(fill=songuoi_km), lwd=0) +
  ...
  theme(text = element_text(size=45), axis.text.x = element_text(size=30), axis.text.y = element_text(size=30), legend.text=element_text(size=30), legend.key.size = unit(2, "cm")) +
  ggtitle("Họ Võ")
ggsave(filename = file.path("figures", "Ho Vo-PerArea-River.png"), width = 49, height = 33)
ggsave(filename = file.path("figures", "Ho Vo-PerArea-River.jpeg"), width = 49, height = 33)
```

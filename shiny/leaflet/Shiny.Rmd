...
dat1 <- dat %>% filter(Ho %in% c("Bùi", "Đào", "Đặng", "Đoàn", "Đinh", "Dư", "Dương", "Hồ", "Hoàng", "Huỳnh", "Triệu", "Khúc", "Lã", "Lê", "Lý", "Mạc", "Mai", "Ngô", "Nguyễn", "Phạm", "Phan", "Phùng", "Quách", "Tôn", "Trần", "Trịnh", "Trương", "Vi", "Võ", "Vũ", "Vương"))

...
```{r load data2}
load("D:/Viet/Thong-ke-Ho-Viet/data/hoviet.RData")
```
...
dat_sff <- dat_sff %>% st_as_sf(crs = 4326)
...
dat1 <- dat %>% filter(Ho %in% c("Mai", "Phùng", "Ngô"))

save(dat, file = "D:/Viet/Thong-ke-Ho-Viet/data/dat.RData")
saveRDS(dat, file = "D:/Viet/Thong-ke-Ho-Viet/data/dat.rds")
saveRDS(dat1, file = "D:/Viet/Thong-ke-Ho-Viet/data/dat1.rds")
```
